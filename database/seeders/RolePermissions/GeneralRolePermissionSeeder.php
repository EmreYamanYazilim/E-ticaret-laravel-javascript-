...
class GeneralRolePermissionSeeder extends Seeder
{
    ...
    {
          /* toplu şekilde tabloya veri yükleme model üzerinden yok
    izinleri toplu şekilde aktarmak için
    DB sınıfı üzerinden insert ile toplu olarak array olarak alacak topluş şekilde ekleyeceğim
    DB table sınıfı ile verdiğimde created_at bölümleri otomatik oluşmuyor !!
    */
